...
//Ans : output1 : undefined , output2 : 'arya';
//Why are they different
//Can I use . dot notation to access the value (using variable name). Explain reason?
//ans : it will give output of undefined . why because it is not key 
//What is the difference between . dot notation and [] bracket notation. Explain
//ans: for double names and numbers we will use bracket. for single name we will go with . nototion
